...
const connectDatabase = async () => {
    try {
        ...
        // In production: only authenticate (use migrations for schema changes)
        // In development: auto-sync schema
        if (process.env.NODE_ENV === 'production') {
            // Production — schema managed by migrations, just verify connection
            await sequelize.authenticate();
        } else {
